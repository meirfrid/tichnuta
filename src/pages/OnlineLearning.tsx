...
const OnlineLearning = () => {
  ...
  const methodSteps = ["נרשמים לקורס ומקבלים גישה מיידית לפלטפורמה", "משתתפים בשיעור חי בזום בשעה קבועה עם המדריך.\nבנוסף, כל השיעורים מוקלטים וזמינים לצפייה חוזרת", "מתרגלים עם תרגילים מעשיים אחרי כל שיעור", "שואלים שאלות בפורום ומקבלים מענה מהמדריך", "מתקדמים לשיעור הבא כשאתם מוכנים"];
