...
const OnlineLearning = () => {
  ...
  const methodSteps = ["נרשמים לקורס ומקבלים גישה לפלטפורמה", "מצטרפים לשיעור חי בזום בשעה קבועה עם המדריך והקבוצה", "לומדים ומתרגלים יחד עם חברי הקבוצה בזמן אמת", "כל הקלטות השיעורים וחומרי הלימוד זמינים באזור האישי באתר", "שואלים שאלות בפורום ומקבלים מענה מהמדריך"];
